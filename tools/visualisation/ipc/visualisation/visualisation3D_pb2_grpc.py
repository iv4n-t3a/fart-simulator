...
class Particle3DObserverStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ObserveParticle = channel.unary_unary(
                '/ipc.visualisation.particles3D.Particle3DObserver/ObserveParticle',
                request_serializer=ipc_dot_visualisation_dot_visualisation3D__pb2.Particle3D.SerializeToString,
                response_deserializer=ipc_dot_visualisation_dot_visualisation3D__pb2.Empty.FromString,
                )
...
def add_Particle3DObserverServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ObserveParticle': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ipc_dot_visualisation_dot_visualisation3D__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ipc.visualisation.particles3D.Particle3DObserver', rpc_method_handlers)
...
class Particle3DObserver(object):
    ...
    def ObserveParticle(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ipc.visualisation.particles3D.Particle3DObserver/ObserveParticle',
            ipc_dot_visualisation_dot_visualisation3D__pb2.Particle3D.SerializeToString,
            ipc_dot_visualisation_dot_visualisation3D__pb2.Empty.FromString,
